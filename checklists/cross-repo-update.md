...
1. **LAUNCHPAD Sweep**
   - [ ] Confirm `daily-tasks.md` and `next-actions.md` reference the repos you intend to move.
   - [ ] Update `project-priorities.md` with the primary/secondary repo names and expected outcomes.
...
3. **PortfolioHub / Master Docs**
   - [ ] Add links to any new repos or artifacts (figures, scripts) in `PortfolioHub.md`.
   - [ ] Reflect major milestones in `MASTER_TIMELINE.md` and `PLAYBOOK.md` if strategy shifted.
4. **Publishing Prep**
...
5. **Review + Debrief**
   - [ ] Fill in `LAUNCHPAD/weekly-review.md` with what shipped and what felt stuck.
